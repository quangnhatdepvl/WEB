      ...
      <!-- partial:partials/_sidebar.jsp -->
		  <nav class="sidebar sidebar-offcanvas" id="sidebar">
			<ul class="nav">
			  ...
			  <li class="nav-item">
				...
				<div class="collapse" id="ui-basic">
				  <ul class="nav flex-column sub-menu">
					<li class="nav-item"> <a class="nav-link" href="phimdangPhat.jsp">Phim đang phát</a></li>
					<li class="nav-item"> <a class="nav-link" href="phimsapRa.jsp">Phim sắp ra mắt</a></li>
				  </ul>
				</div>
			  </li>
			  <li class="nav-item">
			  ...
			  <li class="nav-item">
				<a class="nav-link" href="thongketruycap.jsp">
				  <i class="mdi mdi-chart-pie menu-icon"></i>
				  <span class="menu-title">Thống kê truy cập</span>
				</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="topPhim.jsp">
				  <i class="mdi mdi-grid-large menu-icon"></i>
				  <span class="menu-title">Top Phim</span>
				</a>
			  </li>
