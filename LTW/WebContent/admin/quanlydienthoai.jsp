  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-xs-12">
        <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer" role="grid"
          ...
          <thead>
            <tr role="row">           
              ...
              <th tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1"
				...
				<th tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1"
                aria-label="Kiểu điện thoại: activate to sort column ascending" style="width: 200px;">Kiểu điện thoại</th>
              <th tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1"
          ...
          <tbody>
            ...
            <tr role="row" class="even">            
              ...
              <td></td>
              <!-- phần xóa  -->
              <td class="center"><a data-toggle="modal" data-target="#myModal1"><button title="Xóa bài viết" type="button"
                    class="btn btn-xs btn-danger btn-round">
                    <i class="ace-icon fa fa-trash-o bigger-120"></i>
                  </button></a> <a href="">

                  <button  title="Sửa bài viết" class="btn btn-xs btn-info btn-round">
        ...
        <a href="add.jsp"><button type="button" class="btn btn-white btn-warning btn-round"
